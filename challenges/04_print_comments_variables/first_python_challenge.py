...
# to figure out how old Google is. Then print it out
# ex: my_age = current_year - birth_year


# 2.2 How many _months_ old is Google? Create a new variable google_age_months, and use multiplication to figure it out,
# then print the info.
